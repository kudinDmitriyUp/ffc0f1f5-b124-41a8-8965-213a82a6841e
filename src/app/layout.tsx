...
export const metadata: Metadata = {
  title: "DuckBar - Authentic Ukrainian Bar & Restaurant",
  description: "Experience authentic Ukrainian hospitality, traditional cuisine, and premium spirits at DuckBar. Your local favorite gathering place for genuine Ukrainian culture.",
  keywords: "Ukrainian bar, traditional cuisine, local restaurant, hospitality, vodka, authentic food",
  metadataBase: new URL("https://duckbar.local"),
  alternates: {
    canonical: "https://duckbar.local"
  },
  openGraph: {
    title: "DuckBar - Authentic Ukrainian Bar",
    description: "Join us for authentic Ukrainian food, drinks, and unforgettable moments",
    url: "https://duckbar.local",
    siteName: "DuckBar",
    type: "website",
    images: [
      {
        url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32SgGlSmvaVv2SYOkECykbr8Q49/uploaded-1764141743949-10vloa3t.jpg",
        alt: "DuckBar interior"
      }
    ]
  },
  twitter: {
    ...
    title: "DuckBar - Authentic Ukrainian Bar",
    description: "Experience authentic Ukrainian culture at DuckBar",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32SgGlSmvaVv2SYOkECykbr8Q49/uploaded-1764141743949-10vloa3t.jpg"]
  },
  robots: {
    index: true,
    follow: true
